...
setup(name='micropython-cpython-ussl',
      version='0.1',
      description='MicroPython module ussl ported to CPython',
      ...
      license='Python',
      py_modules=['ussl'],
      install_requires=['micropython-cpython-micropython', 'micropython-cpython-uio'])
