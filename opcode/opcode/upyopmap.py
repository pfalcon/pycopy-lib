...
# 0x40
'SETUP_FINALLY', 'END_FINALLY', 'GET_ITER', 'FOR_ITER', 'POP_BLOCK', 'POP_EXCEPT', 'UNWIND_JUMP', 'GET_ITER_STACK', 
# 0x48
None, None, None, None, None, None, None, None, 
# 0x50
'BUILD_TUPLE', 'BUILD_LIST', None, 'BUILD_MAP', 'STORE_MAP', None, 'BUILD_SET', 'STORE_COMP', 
# 0x58
'BUILD_SLICE', 'UNPACK_SEQUENCE', 'UNPACK_EX', 'RETURN_VALUE', 'RAISE_VARARGS', 'YIELD_VALUE', 'YIELD_FROM', 'BUILD_ORDERED_MAP', 
# 0x60
...
# 0xe8
'INPLACE_FLOOR_DIVIDE', 'INPLACE_TRUE_DIVIDE', 'INPLACE_MODULO', 'INPLACE_POWER', 'BINARY_OR', 'BINARY_XOR', 'BINARY_AND', 'BINARY_LSHIFT', 
# 0xf0
'BINARY_RSHIFT', 'BINARY_ADD', 'BINARY_SUBTRACT', 'BINARY_MULTIPLY', 'BINARY_FLOOR_DIVIDE', 'BINARY_TRUE_DIVIDE', 'BINARY_MODULO', 'BINARY_POWER', 
# 0xf8
None, None, None, None, None, None, None, None, 
]
